...
- [[个人如何应对生产关系变革]]：文章提供了个人应对AI时代的第一手实践指南——"成为AI Native"的具体路径（语音优先、外脑知识库、AI Native学习方式），以及"效率悖论"的警示（越高效越疲惫）。
- [[AI接受曲线]]：文章描述了AI接受曲线的现实案例——从"明确拒绝AI"到"不得不接受AI"的配音/漫画从业者，正是AI接受曲线从"早期多数"向"晚期多数"扩散的真实写照。
- [[AI对职业结构的冲击]]：文章详细描述了AI对研究者职业结构的冲击——从"AI辅助"到"AI主导"的转变，以及这一过程中的心理挣扎和职业重构。
- [[信息获取方式的变革]]：文章描述了AI如何改变信息获取方式——从"搜索引擎+阅读"到"AI对话+提炼"的转变，以及这一转变对知识工作者的深远影响。
