...
- [[生产要素变革与战争逻辑失效]]：FSD落地代表AI从数字层向物理层的渗透，这是生产要素变革的最新形态——当AI能够操控物理世界，传统战争的"人力优势"将进一步被削弱。
- [[AI对职业结构的冲击]]：FSD落地直接冲击司机、快递员等物理层劳动者，是AI对职业结构冲击从"白领"向"蓝领"扩展的标志性事件。
- [[2026年投资逻辑转变]]：FSD落地代表AI投资逻辑从"算力基础设施"向"物理层自动化应用"的转变，是2026年投资逻辑转变的重要组成部分。
- [[旧生产关系破坏规律]]：FSD+Agent叙事叠加，代表旧生产关系（以人力成本为护城河的商业模式）被系统性破坏的加速。
